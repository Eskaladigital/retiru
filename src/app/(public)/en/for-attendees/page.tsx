...
const GUARANTEES = [
  ...
  {
    icon: Shield,
    title: 'Flexible, transparent cancellation',
    desc: 'Guaranteed 100% refund within 48 hours of booking, and cancellation terms displayed upfront.',
    detail: 'Before paying you can see exactly what happens if you cancel: deadlines, percentages and refund method. You can cancel for free within 48 hours of booking (if the event starts in more than 7 days) and, if the organizer cancels the retreat, you receive 100% of your payment back with zero additional steps.',
...
const FAQS = [
  ...
  { q: 'Can I cancel my booking?', a: 'Yes, from your dashboard. Within 48 hours of booking you have a guaranteed 100% refund (if the event starts in more than 7 days). After that, the event\u2019s cancellation policy applies, visible on the listing before you book. If a refund applies, you receive the full amount.' },
