...
const FAQS = [
  ...
  { q: 'What if I use manual booking confirmation and miss the deadline?', a: 'Each paid booking has a maximum window (SLA) to accept or reject it in your panel. If it expires with no action, the booking is cancelled. If the attendee was already charged, a full refund is processed and they receive an email. Check pending bookings regularly.' },
];
