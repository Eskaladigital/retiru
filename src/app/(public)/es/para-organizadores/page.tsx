...
const FAQS = [
  ...
  { q: '¿Puedo publicar un evento que se repite cada semana?', a: 'Sí. Al crear el evento marca «Evento periódico» e indica cada cuántos días se repite (7 = semanal, 14 = quincenal). Retiru publica automáticamente las próximas fechas (por defecto 4 a la vista) y, al pasar una, abre la siguiente; en los listados solo aparece la fecha más próxima. Desde tu panel puedes cerrar fechas concretas sin reservas (por ejemplo, vacaciones) o detener la serie cuando quieras. Para la comisión, toda la serie cuenta como un único retiro.' },
