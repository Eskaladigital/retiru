...
const SECTIONS = [
  { title: 'Para asistentes', items: [
    { q: '¿Cómo funciona la reserva?', a: 'Cuando el pago online está activo, en la mayoría de retiros pagas el PVP (precio publicado por persona) en un solo pago seguro con tarjeta (Stripe). Si el retiro tiene un mínimo de plazas y aún no se ha alcanzado, o si el cobro online aún no está disponible (fase de lanzamiento), puedes reservar plaza sin pagar; te avisaremos por email cuando toque completar el pago en Retiru. Retiru gestiona la reserva y el reparto con el organizador, sin recargo extra para ti.' },
    { q: '¿Qué pasa si el organizador debe confirmar mi reserva y no responde a tiempo?', a: 'Cuando un retiro lleva confirmación manual, envías tu solicitud sin pagar nada: el organizador tiene un plazo máximo para aceptarla o rechazarla. Si la acepta, te enviamos por email el enlace para completar el pago (con su propio plazo). Si el plazo vence sin respuesta, la solicitud se anula automáticamente sin coste, porque no habías pagado nada.' },
    { q: '¿Cómo me apunto a una clase o evento que se repite (por ejemplo, cada martes)?', a: 'Al pulsar «Reservar plaza» en un evento periódico puedes elegir entre reservar solo esa fecha o abrir un calendario y marcar varios días a la vez (otra fecha suelta, cada lunes, todas las próximas…), con hasta 7 semanas de antelación. Cada día queda como una reserva independiente, así que puedes cancelar fechas sueltas desde «Mis reservas». Allí también tienes la opción «Ampliar o modificar inscripción» para añadir más días cuando quieras.' },
    { q: '¿Puedo cancelar mi reserva?', a: 'Sí, desde tu panel en «Mis reservas». Durante las 48 horas siguientes a reservar tienes garantía de reembolso del 100 % (si faltan más de 7 días para el inicio). Después aplica la política de cancelación del evento (plazos y porcentajes sobre lo que pagaste), visible en la ficha; la mayoría de eventos usan la flexible: 100 % hasta 7 días antes y 50 % hasta 3 días antes. Si te corresponde reembolso, recibes ese importe íntegro; no aplicamos una retención extra tipo «cuota no reembolsable» sobre tu devolución.' },
  ...
  { title: 'Para organizadores', items: [
    ...
    { q: '¿Cómo empiezo a publicar retiros?', a: 'Crea tu cuenta con email y verifica tu email. En «Mis eventos» acepta el contrato de organizador y sube la documentación que te pedimos (identidad, alta económica, seguro RC, datos fiscales y bancarios). Puedes crear borradores y enviarlos a revisión en paralelo. Para que un retiro se publique, nuestro equipo debe homologar tu perfil y aprobar el retiro (suelen ser 24-48h cuando la documentación está completa). Más detalle en «Para centros y organizadores».' },
    ...
    { q: '¿Mis retiros pasan revisión?', a: 'El contenido de los retiros lo revisamos para calidad. Además, tu perfil de organizador debe estar homologado con documentación antes de que podamos aprobar y publicar cualquier retiro. Cuando ya tienes al menos un retiro publicado, los nuevos pueden publicarse directamente sin cola de revisión (confianza progresiva).' },
    { q: '¿Puedo publicar un evento que se repite (por ejemplo, cada martes)?', a: 'Sí. Al crear el evento marca «Evento periódico» e indica cada cuántos días se repite (7 = semanal); un evento ya creado también puede convertirse en periódico desde su edición. Retiru publica automáticamente las próximas fechas y abre una nueva cuando pasa la anterior; en los listados solo aparece la más próxima. Desde tu panel puedes cerrar fechas sin reservas (vacaciones) o detener la serie cuando quieras, y toda la serie cuenta como un solo retiro para tu nivel de comisión. Los asistentes pueden apuntarse a una fecha suelta o a varias a la vez desde un calendario (hasta 7 semanas de antelación).' },
    { q: '¿Puedo publicar clases sin tener un centro en el directorio?', a: 'Sí. Si eres profesor independiente o un estudio que ofrece clases puntuales o semanales, puedes publicarlas sin ficha de centro. Creas cuenta, aceptas el contrato de organizador y publicas tu clase o taller como evento (también periódico, p. ej. yoga semanal). Las mismas herramientas de reserva, mensajería y cobro aplican. Empieza desde «Para centros y organizadores».' },
