    ...
    <div>
      <div className="flex items-start justify-between gap-4 mb-8">
        <div>
          ...
          <p className="text-sm text-[#7a6b5d]">Conversaciones con asistentes</p>
        </div>
        <button
          onClick={openSupport}
      ...
      {loading ? (
        ...
        <div className="text-center py-16">
          ...
          <p className="text-sm text-[#7a6b5d] max-w-sm mx-auto">
            Las conversaciones con asistentes de tus retiros aparecerán aquí.
          </p>
        </div>
      ) : (
            ...
            return (
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-xs text-terracotta-600 truncate">
                    {c.is_support ? 'Soporte Retiru' : (c.retreat?.title_es ?? 'Retiro')}
                  </p>
                </div>
                {c.unread_count > 0 && (
