...
export default async function RetirosCategoriaDestinoPage({ params }: { params: Promise<{ category: string; destination: string }> }) {
  ...
  const pastRetreats =
    retreats.length === 0
      ? (await getPastPublishedRetreats({ categorySlug: category, destinationSlug: destination, limit: 12 })).retreats
      : [];
      ...
      <div className="container-wide py-10">
        ...
        {retreats.length === 0 ? (
          <PastRetreatsFallback
            ...
            heading={`No hay retiros de ${cat.name_es} en ${dest.name_es} con fechas abiertas`}
