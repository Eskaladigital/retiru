...
const GUARANTEES = [
  ...
  {
    icon: Shield,
    title: 'Cancelación flexible y transparente',
    desc: 'Garantía de reembolso del 100 % durante las 48 h siguientes a reservar, y condiciones de cancelación visibles desde el principio.',
    detail: 'Antes de pagar ves exactamente qué ocurre si cancelas: plazos, porcentajes y método de devolución. Puedes cancelar gratis durante las 48 horas siguientes a tu reserva (si faltan más de 7 días para el inicio) y, si el organizador cancela el retiro, recibes el 100 % de tu pago sin ningún trámite adicional.',
...
const FAQS = [
  ...
  { q: '¿Puedo cancelar mi reserva?', a: 'Sí, desde tu panel. Durante las 48 horas siguientes a reservar tienes garantía de reembolso del 100 % (si faltan más de 7 días para el inicio). Después aplica la política de cancelación del evento, visible en la ficha antes de reservar. Si te corresponde reembolso, lo recibes íntegro.' },
