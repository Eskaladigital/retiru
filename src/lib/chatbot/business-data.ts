...
- Payments: Stripe (card). Booking/cancel rules: see help. 48h cooling-off 100% refund if the event starts in more than 7 days.
...
- Pagos: Stripe (tarjeta). Reserva/cancelación: ver ayuda. 48 h de arrepentimiento con 100 % si faltan más de 7 días para el inicio.
